#ifndef _HAVE_CALPGM_H
#define _HAVE_CALPGM_H
...
int hamx(spcs_t *spcs, const int iblk, const int nsiz, const int npar, const bcd_t *idpar,
         const double *par, /*@out@*/ double *egy, /*@out@*/ double *t, 
         /*@out@*/ double *dedp, /*@out@*/ double *pmix, const BOOL ifdump);
int setint(spcs_t *spcs, FILE *lu, /*@out@*/BOOL *ifdiag, /*@out@*/int *nsav, const int ndip,
           bcd_t *idip, /*@out@*/ int *isimag);
int intens(spcs_t *spcs, const int iblk, const int isiz, const int jblk, const int jsiz,
           const int ndip, const bcd_t *idip, const double *dip,
           /*@out@*/double *s);
int getqn(spcs_t *spcs, const int iblk,const int indx,const int maxqn, /*@out@*/short *iqn, 
          /*@out@*/int *idgn);
int setopt(spcs_t *spcs, FILE *lu, /*@out@*/ int *nfmt, /*@out@*/ int *itd,
           /*@out@*/ int *nbcdpar, /*@out@*/char *namfil);
int setfmt(spcs_t *spcs, /*@out@*/ int *iqnfmt, int nfmt);
int setblk(spcs_t *spcs, FILE *lu, const int npar, bcd_t *idpar, const double *par,
           int *nblkpf, int *negy);
/************** SUBFIT interfaces ***********************************/
