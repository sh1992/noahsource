...
static const double tiny = 1.e-36;
static const double machep = 1e-15;
...
#define NCARD 130
  /*
   * Probably not necessary to be static based on k-nv interaction below.
   * Note that this makes "second-comma" mode in pcard a fatal error, since
   * its behavior would become incorrect.
   */
...
{                               /*  read in .LIN card from LU */
  static const double terr = 1.e-07;
  static const double txwt = 1.e-30;
  static const double big = 1000.;
  static const int fmt[20] = { 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
                         3, 3, 3, 3, 3, 3, 3, 3, 3, 3};
  double val[20];
  int j, jd, k, nn, nc;
  char ctmp;
